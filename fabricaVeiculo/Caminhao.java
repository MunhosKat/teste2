...
public class Caminhao extends Veiculo {
	...
	public Caminhao(String cor,Motor motor, Pneu pneu, Transmissao transmissao, String numeroSerie, String placa, String porte,
			String modelo, double limiteVeiculo, double valorVeiculo) {
		super(cor, motor, pneu, transmissao, numeroSerie, placa, porte, modelo, limiteVeiculo, valorVeiculo);
	}
